...
common = curr_dir_path[:-5] #"task2" occupies 5 places. This is the path of the common directory
...
#using the model for our data-
#training done in colabs 
...
#testing is on this dataset of ours and the outcomes are obtained
